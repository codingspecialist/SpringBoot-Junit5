...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT) // 서블릿을 mocking 한것이 동작한다. (내장 톰켓 사용 안함)
public class BookControllerIMockTest {
	...
	@AfterEach
	public void end() {
		bookRepository.deleteAll(); // 각각이 끝나고 롤백되는데 deleteAll을 한 이유는 @BeforeEach는 롤백 안됨.
